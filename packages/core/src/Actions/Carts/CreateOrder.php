        ...
        $this->passThrough = DB::transaction(function () use ($cart, $allowMultipleOrders, $orderIdToUpdate) {
            ...
            if ($user) {
                ...
                $shippingAddress = Address::firstOrCreate([
                    ...
                    'company_address' => $cartShippingData->company_address,
                    'tax_identifier' => $cartShippingData->tax_identifier,
                    'tax_identifier_vat' => $cartShippingData->tax_identifier_vat,
                ...
                $billingAddress = Address::firstOrCreate([
                    ...
                    'company_address' => $cartBillingData->company_address,
                    'tax_identifier' => $cartBillingData->tax_identifier,
                    'tax_identifier_vat' => $cartBillingData->tax_identifier_vat,
